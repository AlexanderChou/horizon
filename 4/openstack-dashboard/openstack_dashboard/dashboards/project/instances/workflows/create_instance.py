...
#                                          required=False)
  ...
  #  totalPrice = forms.CharField(max_length=80, label=_("totalPrice(RMB per DAY)"))
    ...
    delete_on_terminate = forms.BooleanField(label=_("Delete on Terminate"),
                                             ...
                                             help_text=_("Delete volume on "
                                                         "instance terminate"))
#    totalPrice = forms.CharField(max_length=80, label=_("totalprice"))
    class Meta:
        name = _("Details")
...
class SetInstanceDetails(workflows.Step):
    ...
    contributes = ("source_type", "source_id",
                   "availability_zone", "name", "count", "flavor", "totalPrice"
...
#	print data
       # print context
        context['totalPrice']=data['totalPrice']
        return context
